...
<main>
    <div class="container">
        ...
        <section class="search-quan">
                ...
                <form action="thucdon.php" method="GET">
                    <input name="search" type="text" placeholder="Tìm sản phẩm bạn muốn mua">
                </form>
            </section>
        </div>
        <!-- <div class="bg-grey">
    ...
    border-radius: 10px;
    margin-right: 10px;" src="<?='admin/product/'.$product['thumbnail'] ?>" alt="">
                            <div class="about">
                                <p><?= $product['content'] ?></p>
                ...
                <aside>
                    <h1 style="margin-left: 20px;">Gợi ý cho bạn</h1>
                        ...
                        foreach ($productList as $item) {
                            echo '
                                    ...
                                    <a href="details.php?id=' . $item['id'] . '">
                                        <img style="padding: 10px 10px 10px 10px;
                                        border-radius: 10px;
                                        margin-right: 10px;" src="admin/product/'.$item['thumbnail'] . '" alt="">
                                        <div class="about">
                                            <div class="title">
                                                <p>' . $item['title'] . '</p>
            ...
            <section class="restaurants">
                <div class="title">
                    <h1>Sản phẩm được bán <span class="green">Trái cây</span></h1>
                </div>
