        ...
        <div class="container">
            <form action="" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input style="width:50%" type="password" name="password" class="form-control" placeholder="Mật khẩu hiện tại">
                </div>
                <div class="form-group">
                    <label for="">Mật khẩu mới:</label>
                    <input style="width:50%" type="password" name="password-new" class="form-control" placeholder="Mật khẩu mới">
                </div>
                <div class="form-group">
                    <label for="">Nhập lại mật khẩu mới:</label>
                    <input style="width:50%" type="password" name="repassword-new" class="form-control" placeholder="Nhập lại mật khẩu mới">
                </div>
