        ...
        <div class="container">
            <form action="login.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input style="width:50%" type="text" name="username" class="form-control" placeholder="Tài khoản">
                </div>
                <div class="form-group">
                    <label for="">Mật khẩu:</label>
                    <input style="width:50%" type="password" name="password" class="form-control" placeholder="Mật khẩu">
                </div>
